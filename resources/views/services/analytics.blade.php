            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 text-gray-500">
                        ...
                        <br><br>
                        <strong>Current Database:</strong> {{ $totalUsers }} total user accounts with complete analytics and reporting capabilities.
                    </div>
                </div>
                ...
                <div class="bg-gray-200 bg-opacity-25 p-6 lg:p-8">
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-2xl font-bold text-gray-900">{{ $activeToday }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-2xl font-bold text-gray-900">{{ $newThisMonth }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Analytics Actions</h3>
                        <div class="flex flex-wrap gap-4">
                            <button class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition duration-200">
                                📊 Generate Report
                            </button>
                            <button class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md text-sm font-medium transition duration-200">
                                📈 Export Statistics
                            </button>
                            <button class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md text-sm font-medium transition duration-200">
                                📋 User Summary
                            </button>
                            <button class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md text-sm font-medium transition duration-200">
                                🔍 Detailed Analysis
                            </button>
                        </div>
                    </div>
