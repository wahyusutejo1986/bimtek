            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-2xl mb-8">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <a href="{{ route('services.dashboard') }}" class="flex items-center p-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition duration-300 transform hover:scale-105 border-2 border-blue-300">
                            <i class="fas fa-search text-2xl mr-3"></i>
                            <div>
                                <div class="font-semibold">� Content Search</div>
